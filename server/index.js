...
// All teams qualify for all rounds. Rank-based cutoffs removed.

// Eligibility check removed to let every team play all rounds.
...
app.post('/api/login', async (req, res) => {
    ...
    // Eligibility check removed to allow all teams to play all rounds.
...
// Endpoint kept for compatibility but always returns eligible: true
